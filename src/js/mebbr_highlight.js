...
var hljs=function(){"use strict";function e(t){
    ...
    className:"variable",variants:[{begin:"\\$\\("+e.UNDERSCORE_IDENT_RE+"\\)",contains:[e.BACKSLASH_ESCAPE]},{begin:/\$[@%<\^?\+\*]/}]},a={className:"string",begin:/"/,end:/"/,contains:[e.BACKSLASH_ESCAPE,i]},n={className:"variable",
    ...
    starts:i},{className:"attr",relevance:0,begin:s+n+"$"}]}}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
    ...
    begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";return e=>{const t=(e=>{
    function t(e){return"(?:"+e+")?"}var n=e.COMMENT("//","$",{contains:[{
    begin:/\\\n/}]
    }),r="[a-zA-Z_]\\w*::",a="(decltype\\(auto\\)|"+t(r)+"[a-zA-Z_]\\w*"+t("<.*?>")+")",i={
    className:"keyword",begin:"\\b[a-z\\d_]*_t\\b"},s={className:"string",
    ...
    t.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],t}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
